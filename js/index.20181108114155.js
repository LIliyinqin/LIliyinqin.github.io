...
$('.js-2').attr('src', (dpi>1) ? 'images/1-242-1.png' : 'images/1-121-1.png');
$('.js-3').attr('src', (dpi>1) ? 'images/about-me-guan-yu-wo-294.png' : 'images/about-me-guan-yu-wo-147.png');
...
$('.js-7').attr('src', (dpi>1) ? 'images/bitmap-710-1.jpg' : 'images/bitmap-355-1.jpg');
